...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 '>
      ...
      {/* ----------left side-------- */}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-7 m-auto md:py-[8vw] md:mb-[-30px]'>
      ...
      <div className='md:w-1/2 relative'>
        <img className='w-full md:absolute bottom-7 h-auto rounded-lg' src={assets.header_img} alt="" />
      </div>
    </div>
  )
}
