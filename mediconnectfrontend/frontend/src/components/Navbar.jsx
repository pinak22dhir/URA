      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 text-lg font-medium">
            ...
            <NavLink onClick={() => setShowMenu(false)} to="/article">
              <p className="px-4 py-2 rounded inline-block">ARTICLES</p>
            </NavLink>
            ...
            <NavLink onClick={() => setShowMenu(false)} to="/chatbot">
              <p className="px-4 py-2 rounded inline-block">MEDICO AI</p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="http://localhost:5176/">
              <p className="px-4 py-2 rounded inline-block">SHOP NOW</p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="http://localhost:3001/">
              <p className="px-4 py-2 rounded inline-block">FEM TRACK</p>
            </NavLink>
          </ul>
        </div>
      </div>
